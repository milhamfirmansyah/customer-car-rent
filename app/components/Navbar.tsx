...
function Navbar() {
  ...
  return (
    <div className="w-full bg-[#F1F3FF] py-6 fixed">
      <div className="flex items-center justify-between max-w-[328px] mx-auto lg:max-w-[1168px]">
        ...
        <div className={menu ? "w-[180px] bg-[#FFF] fixed top-0 right-0 bottom-0 z-20 pt-[34px] pl-4 pr-6 duration-300" : "w-[180px] bg-[#FFF] fixed top-0 right-0 bottom-0 z-20 pt-[34px] pl-4 pr-6 translate-x-[180px] duration-300 lg:translate-x-0 lg:w-[440px] lg:bg-[#F1F3FF] lg:static lg:p-0"}>
