    ...
    <div className="w-[1047px] h-[106px] bg-[#FFF] shadow-md mx-auto rounded-lg translate-y-[-40px] pl-[28px] pr-[20px] pt-[17px] pb-[31px] flex justify-between items-end">
      ...
      <div>
        ...
        <input
          ...
          className="w-[219px] h-9 py-[9px] px-3 outline-none border border-[#CCC] rounded-sm placeholder:text-xs placeholder:leading-[18px] placeholder:font-light text-xs"
        />
      </div>
